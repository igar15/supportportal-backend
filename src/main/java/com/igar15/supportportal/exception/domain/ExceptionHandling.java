...
public class ExceptionHandling {
    ...
    // See application.properties spring.mvc.throw-exception-if-no-handler-found=true
...
//    // We implement ErrorController -> override their getErrorPath() method -> go to this error path and send our response instead of showing White-label page
